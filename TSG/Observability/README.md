...
* [Known Issue: VM Startup Failure Due to Excessive Memory Consumption by MonitoringPlatformAgent (AzureEMP Service)](./MonitoringPlatformAgent-MemoryLeak.md)
* [TSG | Resolving TelemetryAndDiagnostics ARC Extension 2.0.30.0 Installation Failure](./Resolving-TelemetryAndDiagnostics-ARC-Extension-2.0.30.0-Installation-Failure.md)