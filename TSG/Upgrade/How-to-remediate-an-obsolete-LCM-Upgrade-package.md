# Overview
This TSG applies to a solution upgrade on an existing 23H2/24H2 cluster where the solution is not currently installed.
...
if ($actionDeployExists -or $actionUpgradeExists -or $hasEceService) { throw "An action started do not proceed with this tsg" }
```
