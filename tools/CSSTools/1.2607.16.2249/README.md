...
| --- | --- | --- |
| [ClearStorageHealthData](./scripts/ClearStorageHealthData.md) | `Invoke-AzsSupportScript -ScriptName "ClearStorageHealthData" -Parameters @{ MaintenanceModeIntent = $true }`<br>`Invoke-AzsSupportScript -ScriptName "ClearStorageHealthData" -Parameters @{ PhysicalDiskIntent = $true; PhysicalDiskPolicy = $true; UniqueId = "<unique-id>" }`<br>`Invoke-AzsSupportScript -ScriptName "ClearStorageHealthData" -Parameters @{ PhysicalDiskIntent = $true; PhysicalDiskPolicy = $true; SerialNumber = "<serial-number>" }`<br>`Invoke-AzsSupportScript -ScriptName "ClearStorageHealthData" -Parameters @{ Name = "<record-name>"; Key = "<entity-key>"; ProviderGuid = "<provider-guid>" }` | A cluster node with `healthapi.dll`. |
