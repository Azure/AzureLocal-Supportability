...
## Windows.Cluster.CSV.State

Checks the state of the Cluster Shared Volumes
...
## Windows.Cluster.CSV.BlockRedirect.Check

Checks for Cluster Shared Volume block redirect scenarios

| Rule | Synopsis |
| --- | --- |
| Windows.Cluster.CSV.BlockRedirect | Checks for Cluster Shared Volume block redirect scenarios |

## Windows.Storage.DirtyRegionTracking.ThresholdCheck

Checks the Dirty Region Tracking values against thresholds.

| Rule | Synopsis |
| --- | --- |
| Windows.Storage.DirtyRegionTracking.ThresholdCheck | Checks the Dirty Region Tracking Threshold has not been exceeded |

## Windows.Storage.Enclosure.State
...
## Windows.Storage.HealthAction.Check

Checks Health actions that have not completed
...
## Windows.Storage.PhysicalDisk.Blocklisted

Checks for blocklisted disks in Storage Spaces

| Rule | Synopsis |
| --- | --- |
| Windows.Storage.PhysicalDisk.Blocklisted | Checks for blocklisted disks in Storage Spaces |

## Windows.Storage.PhysicalDisk.FirmwareDriftCheck
...
## Windows.Storage.PhysicalDisk.State

Checks the state of the Physical Disks Partitions.
...
## Windows.Storage.Pool.OperationalStatus
...
## Windows.Storage.ServerNodeView.Check
...
## Windows.Storage.SmpHost.ServiceStatus

This script checks the SMPHost State

| Rule | Synopsis |
| --- | --- |
| Windows.System.Service.State | This script checks the state of a service on the system. |

## Windows.Storage.SupportedComponents.Missing

Checks if Supported Components is missing configuration.

| Rule | Synopsis |
| --- | --- |
| Windows.Storage.SupportedComponents.Missing | Checks for missing Supported Components from Storage Spaces |

## Windows.Storage.VirtualDisk.OperationalState
...
Checks the state of Storage Volumes

| Rule | Synopsis |
| --- | --- |
| Windows.Storage.Volume | Checks Storage Volume Health and Status |

## Windows.Storage.SDDCGroup.ResourceState
...
## Windows.Cluster.PhysicalDisk.DiskRunChkDsk
